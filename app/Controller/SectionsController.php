 ...
 */
	public function view($id = null) {
        if (!empty($this->params->slug))
            $id = $this->Section->getIdFromSlug($this->params->slug);
 ...
 */
	public function admin_index() {
        ...
        if (!empty($this->request->data['search_string'])) {
            ...
            $options['conditions'] = array('OR' => array('Section.title_eng LIKE' => "%$search_string%", 'Section.title_fra LIKE' => "%$search_string%", 'Section.body_eng LIKE' => "%$search_string%", 'Section.body_fra LIKE' => "%$search_string%", 'Section.slug LIKE' => "%$search_string%"));
        }
