...
<div class="sections view">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td><strong><?php echo __('Slug Eng'); ?></strong></td>
            <td>
                <?php echo '/sections/'.h($section['Section']['slug_eng']); ?>
                &nbsp;
            </td>
        </tr>
        <tr>
            <td><strong><?php echo __('Slug Fra'); ?></strong></td>
            <td>
                <?php echo '/sections/'.h($section['Section']['slug_fra']); ?>
                &nbsp;
            </td>
        </tr>
        <tr>
