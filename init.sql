...
CREATE TABLE IF NOT EXISTS `contents` (
  ...
  `laureate_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `section_id` (`section_id`,`laureate_id`,`jury_id`)
